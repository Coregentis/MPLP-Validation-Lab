...
import { gateCrosslinkSSOT } from './crosslink-ssot-01';
import { gateDeterminism } from './det-01';
import { gateHostAllowData } from './host-allow-data-01';
import { gateHostAllowUI } from './host-allow-ui-01';
...
import { gateInventorySSOT } from './inventory-ssot-01';
import { gateNavDiscoverability } from './nav-discoverability-01';
import { gateNoFS } from './no-fs-01';
import { gateNoLegacy } from './no-legacy-01';
...
import { gateReleaseHygiene } from './release-hygiene-01';
import { gateReleaseIdentity } from './release-identity-01';
...
import { gate as roleModelGate } from './check-ux-role-model-01';
import { gate as roleJourneysGate } from './check-ux-role-journeys-01';
import { gate as caseFirstFoldGate } from './check-ux-case-firstfold-01';
import { gate as lawFirstFoldGate } from './check-ux-law-clause-firstfold-01';
import { gate as interopVisualGate } from './check-interop-visual-01';
import { gate as homeLandingGate } from './check-ux-home-landing-01';
import { gate as startRoleGate } from './check-ux-start-role-gateway-01';
import { gate as lawsHeroGate } from './check-ux-laws-hero-01';
import { gate as httpHealthGate } from './check-http-health-keyroutes-01';
