 ...
 * - V1 ruleset manifests under data/rulesets/
 * - V1 ruleset requirements under data/rulesets/
 * - V2 ruleset bundles under public/_data/v2/rulesets/
 *
 * Related supporting registry:
 * - lib/rulesets/registry.ts (adjudicator registry used by evaluation/runtime paths)
 *
 * This route is an aggregate projection over V1 filesystem rulesets and V2 bundle files.
 */
                ...
                <div className="max-w-5xl mx-auto px-6 py-12">
                    ...
                    <div className="bg-red-500/10 border border-red-500/30 rounded-2xl p-8">
                        ...
                        <div className="bg-mplp-dark-soft/50 p-4 rounded border border-mplp-border/20 font-mono text-sm">
                            ...
                            <p><span className="text-mplp-text-muted">Loader Probes:</span></p>
                            <ul className="list-disc list-inside text-xs text-mplp-text-muted/60 mt-1">
                                <li>data/rulesets/&lt;ruleset&gt;/manifest.yaml + requirements/*.yaml</li>
                                <li>public/_data/v2/rulesets/ruleset-v&lt;version&gt;.json</li>
                                <li>public/_data/v2/rulesets/ruleset-&lt;version&gt;.json</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-glass border border-mplp-border/40 rounded-2xl p-8 mb-8">
                    ...
                    <div className="prose prose-invert prose-sm max-w-none text-mplp-text-muted/80 mb-8 border-t border-mplp-border/20 pt-6">
                        ...
                        <p>
                            ...
                            {ruleset.source === 'v1' && ' It is resolved from V1 filesystem manifests and requirement files.'}
                            {ruleset.source === 'v2' && ' It is resolved from V2 ruleset bundle JSON through the unified ruleset loader.'}
                        </p>
                        <p>
                            This page is a source-bound projection over the loaded ruleset asset. Legacy V1 lines may carry historical flow labels,
                            while V2 lines expose clause IDs. Ruleset identity does not redefine protocol invariants or protocol version.
                        </p>
                    </div>

                    <div className="mb-8 bg-mplp-dark-soft/30 border border-mplp-border/20 rounded-lg p-6" data-testid="ruleset-domains">
                        <h3 className="text-lg font-bold text-mplp-text mb-2">Reading Boundary</h3>
                        <p className="text-sm text-mplp-text-muted mb-6">
                            Historical groupings such as <code>D1–D4</code>, legacy <code>golden_flows</code>, or older clause families may appear in some source assets.
                            They should be read as source-lineage structure only unless the loaded ruleset itself explicitly publishes them.
                        </p>
                        <p className="text-sm text-mplp-text-muted">
                            Use the loaded manifest or bundle as the first-order source for this page. Treat older domain ladders and legacy identifiers as historical reading aids only.
                        </p>
                    </div>
                    ...
                    {ruleset.kind === 'clauses' && (
                        <div className="mb-8" data-testid="clauses">
                            <h3 className="text-lg font-bold text-mplp-text mb-4">Clauses</h3>
                    ...
                    {ruleset.kind === 'golden_flows' && (
                        <div className="mb-8" data-testid="golden-flows">
                            ...
                            <p className="text-sm text-mplp-text-muted mb-4">
                                This ruleset uses the legacy <code>golden_flows</code> identifiers instead of V2 clause IDs. These identifiers are legacy Lab labels, not protocol-definition authority.
                            </p>
